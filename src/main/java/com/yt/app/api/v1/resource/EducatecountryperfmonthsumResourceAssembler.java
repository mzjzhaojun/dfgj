...
public class EducatecountryperfmonthsumResourceAssembler extends
		ResourceAssemblerSupport<Educatecountryperfmonthsum, EducatecountryperfmonthsumResource> {
	...
	@Override
	public EducatecountryperfmonthsumResource toResource(Educatecountryperfmonthsum t) {
