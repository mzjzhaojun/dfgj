...
public interface DebookordersMapper extends IBaseMapper<Debookorders> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Debookorders.class})
...
*/
	@RedisCacheAnnotation(classs = Debookorders.class)
...
*/
	@RedisCacheAnnotation(classs = Debookorders.class)
	public List<Debookorders> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Debookorders.class)
	public List<Debookorders> listByArrayId(long[] id);
}