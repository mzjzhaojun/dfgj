...
public interface TeachersearchMapper extends IBaseMapper<Teachersearch> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Teachersearch.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Teachersearch.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Teachersearch.class)
	public List<Teachersearch> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Teachersearch.class)
	public List<Teachersearch> listByArrayId(long[] id);
}