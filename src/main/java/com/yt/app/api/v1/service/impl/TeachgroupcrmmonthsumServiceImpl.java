...
public class TeachgroupcrmmonthsumServiceImpl extends BaseServiceImpl<Teachgroupcrmmonthsum, Long> implements TeachgroupcrmmonthsumService {
	...
	@Override
	@Transactional
	public Integer post(Teachgroupcrmmonthsum t) {
	...
	@Override
	public IPage<Teachgroupcrmmonthsum> list(RequestEntity<Object> requestEntity) {
		...
		List<Teachgroupcrmmonthsum> list = mapper.list(param);
		return new PageBean<Teachgroupcrmmonthsum>(param, list, count);
	}

	@Override
	public Teachgroupcrmmonthsum get(Long id) {
		Teachgroupcrmmonthsum t = mapper.get(id);
		return t;
	}
}