...
public class Refundreport implements Serializable {
	...
	public Refundreport(Long id, Integer version, Long snapshotid, String statdatekey, String statdatename, String regionid, String regionname,
			String branchid, String branchname, String campusid, String campusname, Integer campusage, String staffid, String staffoaname,
			String staffjobtype, String staffjobname, Integer staffage, String grade, String gradename, String refundtype, String refundtypename,
			Object applyrefundmoney, Object realrefundmoney, Integer refundpeople, Object refundaverage) {
		this.id = id;
