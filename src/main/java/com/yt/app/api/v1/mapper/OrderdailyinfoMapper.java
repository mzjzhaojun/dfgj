...
public interface OrderdailyinfoMapper extends IBaseMapper<Orderdailyinfo> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Orderdailyinfo.class})
...
*/
	@RedisCacheAnnotation(classs = Orderdailyinfo.class)
...
*/
	@RedisCacheAnnotation(classs = Orderdailyinfo.class)
	public List<Orderdailyinfo> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Orderdailyinfo.class)
	public List<Orderdailyinfo> listByArrayId(long[] id);
}