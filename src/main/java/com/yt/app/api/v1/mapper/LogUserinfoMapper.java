...
public interface LogUserinfoMapper extends IBaseMapper<LogUserinfo> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { LogUserinfo.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = LogUserinfo.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = LogUserinfo.class)
	public List<LogUserinfo> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = LogUserinfo.class)
	public List<LogUserinfo> listByArrayId(long[] id);
}