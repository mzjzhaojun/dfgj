...
public interface ProductclassstatsMapper extends IBaseMapper<Productclassstats> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Productclassstats.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Productclassstats.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Productclassstats.class)
	public List<Productclassstats> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Productclassstats.class)
	public List<Productclassstats> listByArrayId(long[] id);
}