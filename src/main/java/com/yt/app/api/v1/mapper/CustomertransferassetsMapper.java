...
public interface CustomertransferassetsMapper extends IBaseMapper<Customertransferassets> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Customertransferassets.class})
...
*/
	@RedisCacheAnnotation(classs = Customertransferassets.class)
...
*/
	@RedisCacheAnnotation(classs = Customertransferassets.class)
	public List<Customertransferassets> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Customertransferassets.class)
	public List<Customertransferassets> listByArrayId(long[] id);
}