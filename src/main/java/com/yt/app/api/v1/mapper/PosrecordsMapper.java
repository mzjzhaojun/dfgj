...
public interface PosrecordsMapper extends IBaseMapper<Posrecords> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Posrecords.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Posrecords.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Posrecords.class)
	public List<Posrecords> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Posrecords.class)
	public List<Posrecords> listByArrayId(long[] id);
}