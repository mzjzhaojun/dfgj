...
public interface CampusincomestatMapper extends IBaseMapper<Campusincomestat> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Campusincomestat.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Campusincomestat.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Campusincomestat.class)
	public List<Campusincomestat> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Campusincomestat.class)
	public List<Campusincomestat> listByArrayId(long[] id);
}