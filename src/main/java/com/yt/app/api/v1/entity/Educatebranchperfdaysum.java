...
public class Educatebranchperfdaysum implements Serializable{
  ...
  public Educatebranchperfdaysum(Long id,Integer version,Long regionid,Long branchid,Integer year,Integer month,Integer day,Integer onetoonehourcount,Object onetoonehourincome,Integer grouphourcount,Object grouphourincome,Object renewalmoney,Object refundmoney,String createtime){
      this.id=id;
