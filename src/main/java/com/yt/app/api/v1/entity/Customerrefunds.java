...
public class Customerrefunds implements Serializable{
  ...
  public Customerrefunds(Long id,Integer version,Long refundapplyid,Long staffid,Long staffjobid,Long customerid,String customercode,Long campusid,java.util.Date chargepaytime,java.util.Date refundverifytime,Object refundrealmoney,java.util.Date createtime,Long taskid){
      this.id=id;
