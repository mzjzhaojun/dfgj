...
public interface TeacherjobsMapper extends IBaseMapper<Teacherjobs> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Teacherjobs.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Teacherjobs.class)
	public List<Teacherjobs> list(Map<String, Object> param);
