...
public class ConsultbranchcrmdaysumServiceImpl extends BaseServiceImpl<Consultbranchcrmdaysum, Long> implements ConsultbranchcrmdaysumService {
	...
	@Override
	public Integer post(Consultbranchcrmdaysum t) {
	...
	@Override
	public IPage<Consultbranchcrmdaysum> list(RequestEntity<Object> requestEntity) {
		...
		List<Consultbranchcrmdaysum> list = mapper.list(param);
		return new PageBean<Consultbranchcrmdaysum>(param, list, count);
	}

	@Override
	public Consultbranchcrmdaysum get(Long id) {
		Consultbranchcrmdaysum t = mapper.get(id);
		return t;
	}
}