...
public class Staffchargestat implements Serializable {
	...
	public Staffchargestat(Long id, Integer version, java.util.Date statlocaldate, Long customerid, Long staffid, String staffoacode,
			...
			Integer campusage, Integer staffjobtype, String staffjobname, String grade, String gradename, Integer chargetype, String chargetypename,
			Object chargeamount) {
		this.id = id;
