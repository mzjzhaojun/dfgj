...
public interface CampusDaytaskMapper extends IBaseMapper<CampusDaytask> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { CampusDaytask.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = CampusDaytask.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = CampusDaytask.class)
	public List<CampusDaytask> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = CampusDaytask.class)
	public List<CampusDaytask> listByArrayId(long[] id);
}