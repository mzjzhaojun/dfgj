...
public interface CustomercoursesMapper extends IBaseMapper<Customercourses> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Customercourses.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Customercourses.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Customercourses.class)
	public List<Customercourses> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Customercourses.class)
	public List<Customercourses> listByArrayId(long[] id);
}