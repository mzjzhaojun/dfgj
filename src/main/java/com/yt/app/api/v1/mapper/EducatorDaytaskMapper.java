...
public interface EducatorDaytaskMapper extends IBaseMapper<EducatorDaytask> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { EducatorDaytask.class})
...
*/
	@RedisCacheAnnotation(classs = EducatorDaytask.class)
...
*/
	@RedisCacheAnnotation(classs = EducatorDaytask.class)
	public List<EducatorDaytask> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = EducatorDaytask.class)
	public List<EducatorDaytask> listByArrayId(long[] id);
}