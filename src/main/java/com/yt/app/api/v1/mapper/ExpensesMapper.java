...
public interface ExpensesMapper extends IBaseMapper<Expenses> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Expenses.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Expenses.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Expenses.class)
	public List<Expenses> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Expenses.class)
	public List<Expenses> listByArrayId(long[] id);
}