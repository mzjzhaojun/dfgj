...
public interface ConsultbranchperfdaysumMapper extends IBaseMapper<Consultbranchperfdaysum> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Consultbranchperfdaysum.class})
...
*/
	@RedisCacheAnnotation(classs = Consultbranchperfdaysum.class)
...
*/
	@RedisCacheAnnotation(classs = Consultbranchperfdaysum.class)
	public List<Consultbranchperfdaysum> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Consultbranchperfdaysum.class)
	public List<Consultbranchperfdaysum> listByArrayId(long[] id);
}