...
public interface CustomerassignsMapper extends IBaseMapper<Customerassigns> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Customerassigns.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Customerassigns.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Customerassigns.class)
	public List<Customerassigns> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Customerassigns.class)
	public List<Customerassigns> listByArrayId(long[] id);
}