...
public class Potentialcustomers implements Serializable {
	...
	public Potentialcustomers(Long id, Integer version, Long orgid, String orgname, String orgtype, Long campusid, String campusname,
			String customercode, String customername, String customerlevel, String invalidreason, String customerstatus, Integer isoneparent,
			String describes, java.util.Date birthday, String gender, String email, String idtype, String idnumber, String viptype, String viplevel,
			String entrancegrade, String grade, String schoolyear, String subjecttype, String studenttype, String contacttype, String sourcemaintype,
			String sourcesubtype, String sourcesystem, Long referralstaffid, String referralstaffname, Long referralstaffjobid,
			String referralstaffjobname, String referralstaffoacode, Long referralcustomerid, String referralcustomercode,
			String referralcustomername, String purchaseintention, Long schoolid, String schoolname, Integer isstudyagain, java.util.Date followtime,
			String followstage, Integer followedcount, java.util.Date nextfollowtime, Long creatorid, String creatorname, Long creatorjobid,
			String creatorjobname, String creatorjobtype, java.util.Date createtime, Long modifierid, String modifiername, java.util.Date modifytime,
			Long tenantcode) {
		this.id = id;
