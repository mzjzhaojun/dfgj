...
public class CustomeraccountmonthlystatResourceAssembler extends
		ResourceAssemblerSupport<Customeraccountmonthlystat, CustomeraccountmonthlystatResource> {
	...
	@Override
	public CustomeraccountmonthlystatResource toResource(Customeraccountmonthlystat t) {
