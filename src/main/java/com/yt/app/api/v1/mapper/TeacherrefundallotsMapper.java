...
public interface TeacherrefundallotsMapper extends IBaseMapper<Teacherrefundallots> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Teacherrefundallots.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Teacherrefundallots.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Teacherrefundallots.class)
	public List<Teacherrefundallots> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Teacherrefundallots.class)
	public List<Teacherrefundallots> listByArrayId(long[] id);
}