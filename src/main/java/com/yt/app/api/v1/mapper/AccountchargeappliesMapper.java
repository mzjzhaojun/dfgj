...
public interface AccountchargeappliesMapper extends IBaseMapper<Accountchargeapplies> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Accountchargeapplies.class})
...
*/
	@RedisCacheAnnotation(classs = Accountchargeapplies.class)
...
*/
	@RedisCacheAnnotation(classs = Accountchargeapplies.class)
	public List<Accountchargeapplies> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Accountchargeapplies.class)
	public List<Accountchargeapplies> listByArrayId(long[] id);
}