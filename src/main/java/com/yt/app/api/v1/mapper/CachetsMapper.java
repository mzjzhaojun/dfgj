...
public interface CachetsMapper extends IBaseMapper<Cachets> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Cachets.class})
...
*/
	@RedisCacheAnnotation(classs = Cachets.class)
...
*/
	@RedisCacheAnnotation(classs = Cachets.class)
	public List<Cachets> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Cachets.class)
	public List<Cachets> listByArrayId(long[] id);
}