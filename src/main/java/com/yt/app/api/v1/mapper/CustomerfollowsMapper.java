...
public interface CustomerfollowsMapper extends IBaseMapper<Customerfollows> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Customerfollows.class})
...
*/
	@RedisCacheAnnotation(classs = Customerfollows.class)
...
*/
	@RedisCacheAnnotation(classs = Customerfollows.class)
	public List<Customerfollows> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Customerfollows.class)
	public List<Customerfollows> listByArrayId(long[] id);
}