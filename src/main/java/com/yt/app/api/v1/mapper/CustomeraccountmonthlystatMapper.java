 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Customeraccountmonthlystat.class})
...
*/
	@RedisCacheAnnotation(classs = Customeraccountmonthlystat.class)
...
*/
	@RedisCacheAnnotation(classs = Customeraccountmonthlystat.class)
	public List<Customeraccountmonthlystat> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Customeraccountmonthlystat.class)
	public List<Customeraccountmonthlystat> listByArrayId(long[] id);
}