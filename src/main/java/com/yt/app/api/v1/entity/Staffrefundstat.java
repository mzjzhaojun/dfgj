...
public class Staffrefundstat implements Serializable {
	...
	public Staffrefundstat(Long id, Integer version, java.util.Date statlocaldate, Long customerid, Long staffid, String staffoacode,
			String staffoaname, Long campusid, String campusname, String campusshortname, Long branchid, String branchname, String branchshortname,
			Long regionid, String regionname, String regionshortname, Long hqid, String hqname, String hqshortname, java.util.Date campusdeliverdate,
			Integer campusage, Integer staffjobtype, String staffjobname, String grade, String gradename, Integer refundtype, String refundtypename,
			Object applyrefundmoney, Object realrefundmoney) {
		this.id = id;
