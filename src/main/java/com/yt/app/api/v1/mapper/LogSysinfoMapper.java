...
public interface LogSysinfoMapper extends IBaseMapper<LogSysinfo> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { LogSysinfo.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = LogSysinfo.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = LogSysinfo.class)
	public List<LogSysinfo> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = LogSysinfo.class)
	public List<LogSysinfo> listByArrayId(long[] id);
}