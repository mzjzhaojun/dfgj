...
public interface TeachersMapper extends IBaseMapper<Teachers> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Teachers.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Teachers.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Teachers.class)
	public List<Teachers> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Teachers.class)
	public List<Teachers> listByArrayId(long[] id);
}