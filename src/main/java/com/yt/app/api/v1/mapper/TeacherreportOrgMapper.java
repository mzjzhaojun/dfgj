...
public interface TeacherreportOrgMapper extends IBaseMapper<TeacherreportOrg> {
/**
 * 保存（持久化）对象
 * 
 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { TeacherreportOrg.class})
...
*/
	@RedisCacheAnnotation(classs = TeacherreportOrg.class)
...
*/
	@RedisCacheAnnotation(classs = TeacherreportOrg.class)
	public List<TeacherreportOrg> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = TeacherreportOrg.class)
	public List<TeacherreportOrg> listByArrayId(long[] id);
}