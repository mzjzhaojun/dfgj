...
public class Consultcountryperfmonthsum implements Serializable {
	...
	public Consultcountryperfmonthsum(Long id, Integer version, Integer year, Integer month, Object moneycount, Object peoplecount,
			Object newmoneytask, Object newmoney, Integer newpeoplecount, Integer newpeoplecounttask, java.util.Date createtime) {
		this.id = id;
