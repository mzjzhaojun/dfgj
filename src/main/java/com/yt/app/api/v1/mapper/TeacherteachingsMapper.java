...
public interface TeacherteachingsMapper extends IBaseMapper<Teacherteachings> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Teacherteachings.class})
...
*/
	@RedisCacheAnnotation(classs = Teacherteachings.class)
...
*/
	@RedisCacheAnnotation(classs = Teacherteachings.class)
	public List<Teacherteachings> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Teacherteachings.class)
	public List<Teacherteachings> listByArrayId(long[] id);
}