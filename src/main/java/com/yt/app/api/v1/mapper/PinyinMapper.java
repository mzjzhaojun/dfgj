...
public interface PinyinMapper extends IBaseMapper<Pinyin> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Pinyin.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Pinyin.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Pinyin.class)
	public List<Pinyin> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Pinyin.class)
	public List<Pinyin> listByArrayId(long[] id);
}