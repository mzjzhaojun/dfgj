...
public class Customerteacherrelations implements Serializable {
	...
	public Customerteacherrelations(Long id, Integer version, Long customerid, Long teacherid, String teachername, Long teacherjobid,
			String teacherjobname, String teacheroacode, Long teacherjoborgid, String teacherjoborgname, Integer isfulltimeteacher, Long creatorid,
			String creatorname, java.util.Date createtime) {
		this.id = id;
