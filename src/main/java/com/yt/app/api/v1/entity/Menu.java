...
public class Menu implements Serializable{
  ...
  public Menu(Long id,String name,String parent_id,Integer level,String url,String icon,Long sys_id,Integer order_no,Integer sortno,Integer is_show,Integer version){
      this.id=id;
      this.name=name;
