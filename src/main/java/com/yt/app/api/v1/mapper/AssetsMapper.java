...
public interface AssetsMapper extends IBaseMapper<Assets> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Assets.class})
...
*/
	@RedisCacheAnnotation(classs = Assets.class)
...
*/
	@RedisCacheAnnotation(classs = Assets.class)
	public List<Assets> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Assets.class)
	public List<Assets> listByArrayId(long[] id);
}