...
public interface UserOperationlogMapper extends IBaseMapper<UserOperationlog> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { UserOperationlog.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = UserOperationlog.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = UserOperationlog.class)
	public List<UserOperationlog> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = UserOperationlog.class)
	public List<UserOperationlog> listByArrayId(long[] id);
}