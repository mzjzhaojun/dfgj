...
public class UserOperationlog implements Serializable {
	...
	public UserOperationlog(Long id, Integer version, String resource_id, String subject, String application_name, String program_name,
			Long process_id, Long activity_id, String activity_name, Long operator_id, String operator_name, Long top_dept_id, String top_dept_name,
			Long real_user_id, String real_user_name, java.util.Date operate_datetime, String operate_name, Integer operate_type,
			String operate_description, String http_context, Long correlation_id) {
		this.id = id;
