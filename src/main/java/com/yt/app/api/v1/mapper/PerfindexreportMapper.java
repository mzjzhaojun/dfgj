...
public interface PerfindexreportMapper extends IBaseMapper<Perfindexreport> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Perfindexreport.class})
...
*/
	@RedisCacheAnnotation(classs = Perfindexreport.class)
...
*/
	@RedisCacheAnnotation(classs = Perfindexreport.class)
	public List<Perfindexreport> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Perfindexreport.class)
	public List<Perfindexreport> listByArrayId(long[] id);
}