...
@Getter
@Setter
public class Educatecountrycrmmonthsum implements Serializable {
	...
	public Educatecountrycrmmonthsum(Long id, Integer version, Integer year, Integer month, Integer classpeoplecount, Integer initialeffective,
			Integer neweffective, Integer classhours, Integer finaleffective, Integer renewalcount, Integer endclasscount, Integer refundcount,
			Integer remaininghourscount, Integer outschoolwarningcount, Integer closedwarningcount, Integer refundwarningcount,
