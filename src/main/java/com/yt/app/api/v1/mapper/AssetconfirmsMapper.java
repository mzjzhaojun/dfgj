...
public interface AssetconfirmsMapper extends IBaseMapper<Assetconfirms> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Assetconfirms.class})
...
*/
	@RedisCacheAnnotation(classs = Assetconfirms.class)
...
*/
	@RedisCacheAnnotation(classs = Assetconfirms.class)
	public List<Assetconfirms> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Assetconfirms.class)
	public List<Assetconfirms> listByArrayId(long[] id);
}