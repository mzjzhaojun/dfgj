...
public interface CampuscustomerweeklystatMapper extends IBaseMapper<Campuscustomerweeklystat> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Campuscustomerweeklystat.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Campuscustomerweeklystat.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Campuscustomerweeklystat.class)
	public List<Campuscustomerweeklystat> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Campuscustomerweeklystat.class)
	public List<Campuscustomerweeklystat> listByArrayId(long[] id);
}