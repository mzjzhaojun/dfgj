...
public interface SysMapper extends IBaseMapper<Sys> {
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Sys.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Sys.class)
	public List<Sys> list(Map<String, Object> param);
	 ...
	 * @return
	 */
	public List<Sys> sysmune(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Sys.class)
	public List<Sys> listlevel(int id);
}