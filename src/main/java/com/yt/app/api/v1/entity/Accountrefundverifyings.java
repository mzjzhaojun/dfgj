...
public class Accountrefundverifyings implements Serializable {
	...
	public Accountrefundverifyings(Long id, Integer version, Long applyid, java.util.Date verifytime, String verifyaction, String verifymemo,
			Long verifierid, String verifiername, Long verifierjobid, String verifierjobname, String verifierorgid, String verifierorgname,
