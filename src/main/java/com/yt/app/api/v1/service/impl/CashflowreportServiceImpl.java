...
@Override
public Integer post(Cashflowreport t) {
...
@Override
public IPage<Cashflowreport> list(RequestEntity<Object> requestEntity) {
	...
	List<Cashflowreport> list = mapper.list(param);
	return new PageBean<Cashflowreport>(param, list, count);
}

@Override
public Cashflowreport get(Long id) {
	Cashflowreport t = mapper.get(id);
	return t;
}
}