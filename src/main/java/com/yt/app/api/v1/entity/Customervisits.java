...
public class Customervisits implements Serializable {
	...
	public Customervisits(Long id, Integer version, Long campusid, String campusname, Long customerid, String visittype, String visitway,
			String visitcontent, java.util.Date visittime, Long visitorid, String visitorname, Long visitorjobid, String visitorjobname,
			java.util.Date nextvisittime, String satisficing, java.util.Date remindtime, String creatorid, String creatorname,
