...
@Getter
@Setter
public class EducatorreportOrg implements Serializable {
	...
	public EducatorreportOrg() {
	}

	public EducatorreportOrg(Long id, Integer version, Long snapshotid, String regionid, String regionshortname, String branchid,
			String branchshortname, String campusid, String campusshortname, Integer campusage, Integer belongnumber, Integer managenumber,
			Integer availablenumber, Integer assignednumber, Integer classsuspendednumber, Integer schoolsuspendednumber, Integer refundmoneynumber,
