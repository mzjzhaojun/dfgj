 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Parents.class})
...
*/
	@RedisCacheAnnotation(classs = Parents.class)
...
*/
	@RedisCacheAnnotation(classs = Parents.class)
	public List<Parents> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Parents.class)
	public List<Parents> listByArrayId(long[] id);
}