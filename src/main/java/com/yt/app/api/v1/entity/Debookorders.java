...
public class Debookorders implements Serializable {
	...
	public Debookorders(Long id, Integer version, Long campusid, String campusname, Long parentid, String parentname, Long customerid,
			String customercode, String customername, String debookno, java.util.Date debooktime, String debookstatus, String debookmemo,
			String processstatus, java.util.Date processtime, String processmemo, String contacttel, String contacter, Long submitterid,
			String submittername, Long submitterjobid, String submitterjobname, String submitterjobtype, java.util.Date submittime, Long approverid,
			Long approvername, Long approverjobid, String approverjobname, java.util.Date approvetime, Long creatorid, String creatorname,
