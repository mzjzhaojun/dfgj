...
public class Teachersearch implements Serializable {
	...
	public Teachersearch(Long id, Integer version, Long customerid, Long teacherid, String teachername, Long teacherjobid, Long teacherjoborgid,
			String teacherjoborgname, Long subject, String subjectname, java.util.Date createtime, java.util.Date modifytime) {
		this.id = id;
