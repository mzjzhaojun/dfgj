...
public interface TeachcountrycrmmonthsumMapper extends IBaseMapper<Teachcountrycrmmonthsum> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Teachcountrycrmmonthsum.class})
...
*/
	@RedisCacheAnnotation(classs = Teachcountrycrmmonthsum.class)
...
*/
	@RedisCacheAnnotation(classs = Teachcountrycrmmonthsum.class)
	public List<Teachcountrycrmmonthsum> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Teachcountrycrmmonthsum.class)
	public List<Teachcountrycrmmonthsum> listByArrayId(long[] id);
}