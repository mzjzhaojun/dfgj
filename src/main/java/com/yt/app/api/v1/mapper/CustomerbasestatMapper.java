...
public interface CustomerbasestatMapper extends IBaseMapper<Customerbasestat> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Customerbasestat.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Customerbasestat.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Customerbasestat.class)
	public List<Customerbasestat> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Customerbasestat.class)
	public List<Customerbasestat> listByArrayId(long[] id);
}