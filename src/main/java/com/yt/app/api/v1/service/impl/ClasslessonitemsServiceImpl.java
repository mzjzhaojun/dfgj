...
public class ClasslessonitemsServiceImpl extends BaseServiceImpl<Classlessonitems, Long> implements ClasslessonitemsService {
	...
	@Override
	@Transactional
	public Integer post(Classlessonitems t) {
	...
	@Override
	public IPage<Classlessonitems> list(RequestEntity<Object> requestEntity) {
		...
		List<Classlessonitems> list = mapper.list(param);
		return new PageBean<Classlessonitems>(param, list, count);
	}

	@Override
	public Classlessonitems get(Long id) {
		Classlessonitems t = mapper.get(id);
		return t;
	}
}