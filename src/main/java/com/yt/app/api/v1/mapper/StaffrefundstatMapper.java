...
public interface StaffrefundstatMapper extends IBaseMapper<Staffrefundstat> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Staffrefundstat.class})
...
*/
	@RedisCacheAnnotation(classs = Staffrefundstat.class)
...
*/
	@RedisCacheAnnotation(classs = Staffrefundstat.class)
	public List<Staffrefundstat> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Staffrefundstat.class)
	public List<Staffrefundstat> listByArrayId(long[] id);
}