...
public class Consultbranchcrmmonthsum implements Serializable {
	...
	public Consultbranchcrmmonthsum(Long id, Integer version, Long regionid, Long branchid, Integer year, Integer month,
			Integer followingcountofpotential, Integer followingcountofstudent, Integer verifyingcount, Integer signingcount,
			Integer unfollowcountofpotential, Integer unfollowcountofstudent, Integer unverifycount, Integer unsigncount,
			Integer followedcountofpotential, Integer followedcountofstudent, Integer verifiedcount, Integer signedcount, Integer newpotentialcount,
			Object convertedratio, Object verifiedratio, Object signedratio, java.util.Date createtime) {
		this.id = id;
