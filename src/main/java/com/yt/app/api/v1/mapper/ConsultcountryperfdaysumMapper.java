...
public interface ConsultcountryperfdaysumMapper extends IBaseMapper<Consultcountryperfdaysum> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Consultcountryperfdaysum.class})
...
*/
	@RedisCacheAnnotation(classs = Consultcountryperfdaysum.class)
...
*/
	@RedisCacheAnnotation(classs = Consultcountryperfdaysum.class)
	public List<Consultcountryperfdaysum> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Consultcountryperfdaysum.class)
	public List<Consultcountryperfdaysum> listByArrayId(long[] id);
}