...
public interface JobcodeMapper extends IBaseMapper<Jobcode> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Jobcode.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Jobcode.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Jobcode.class)
	public List<Jobcode> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Jobcode.class)
	public List<Jobcode> listByArrayId(long[] id);
}