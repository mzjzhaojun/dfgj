...
@Getter
@Setter
public class Educatecampuscrmmonthsum implements Serializable {
	...
	public Educatecampuscrmmonthsum() {
	}

	public Educatecampuscrmmonthsum(Long id, Integer version, Long regionid, Long branchid, Long campusid, Integer year, Integer month,
			Integer classpeoplecount, Integer initialeffective, Integer neweffective, Integer classhours, Integer finaleffective,
			Integer renewalcount, Integer endclasscount, Integer refundcount, Integer remaininghourscount, Integer outschoolwarningcount,
			Integer closedwarningcount, Integer refundwarningcount, Integer waitvisitingcount, Integer waitweekfeedbackcount,
			Integer waitmeetingcount, Integer waitordercount, Integer birthdaytoday, Integer birthdayfuture, Integer managestudentcount,
			Integer validstudentcount, Integer noclassstudentcount, Integer closedstudentcount, Integer outschoolstudentcount,
			Integer onlystudentcount, Integer noorderstudentcount, Integer introducecount, Integer switchcount, Integer receivecount,
			Integer newclosedcount, Integer closedactivationcount, Integer newoutschoolcount, Integer outschoolactivationcount,
			java.util.Date createtime) {
		this.id = id;
