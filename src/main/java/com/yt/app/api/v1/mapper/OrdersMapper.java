...
public interface OrdersMapper extends IBaseMapper<Orders> {
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Orders.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Orders.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Orders.class)
	public List<Orders> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Orders.class)
	public List<Orders> listByArrayId(long[] id);
}