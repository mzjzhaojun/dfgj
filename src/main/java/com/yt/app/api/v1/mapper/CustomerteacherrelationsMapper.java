...
public interface CustomerteacherrelationsMapper extends IBaseMapper<Customerteacherrelations> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Customerteacherrelations.class})
...
*/
	@RedisCacheAnnotation(classs = Customerteacherrelations.class)
...
*/
	@RedisCacheAnnotation(classs = Customerteacherrelations.class)
	public List<Customerteacherrelations> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Customerteacherrelations.class)
	public List<Customerteacherrelations> listByArrayId(long[] id);
}