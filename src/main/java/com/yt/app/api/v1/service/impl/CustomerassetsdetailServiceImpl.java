...
public class CustomerassetsdetailServiceImpl extends BaseServiceImpl<Customerassetsdetail, Long> implements CustomerassetsdetailService {
	...
	@Override
	public Integer post(Customerassetsdetail t) {
	...
	@Override
	public IPage<Customerassetsdetail> list(RequestEntity<Object> requestEntity) {
		...
		List<Customerassetsdetail> list = mapper.list(param);
		return new PageBean<Customerassetsdetail>(param, list, count);
	}

	@Override
	public Customerassetsdetail get(Long id) {
		Customerassetsdetail t = mapper.get(id);
		return t;
	}
}