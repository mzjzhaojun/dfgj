...
public interface AccountrefundallotsMapper extends IBaseMapper<Accountrefundallots> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Accountrefundallots.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Accountrefundallots.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Accountrefundallots.class)
	public List<Accountrefundallots> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Accountrefundallots.class)
	public List<Accountrefundallots> listByArrayId(long[] id);
}