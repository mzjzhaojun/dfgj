...
public class Consultcampusperfmonthsum implements Serializable {
	...
	public Consultcampusperfmonthsum(Long id, Integer version, Long regionid, Long branchid, Long campusid, Integer year, Integer month,
			Object moneycount, Integer moneybranchrank, Integer moneycountryrank, Object peoplecount, Integer peoplebranchrank,
			Integer peoplecountryrank, Object newmoneytask, Object newmoney, Integer newmoneybranchrank, Integer newmoneycountryrank,
			Integer newpeoplecount, Integer newpeoplebranchrank, Integer newpeoplecountryrank, Integer newpeoplecounttask, java.util.Date createtime) {
		this.id = id;
