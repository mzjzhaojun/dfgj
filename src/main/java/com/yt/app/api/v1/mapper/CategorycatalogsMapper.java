...
public interface CategorycatalogsMapper extends IBaseMapper<Categorycatalogs> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Categorycatalogs.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Categorycatalogs.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Categorycatalogs.class)
	public List<Categorycatalogs> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Categorycatalogs.class)
	public List<Categorycatalogs> listByArrayId(long[] id);
}