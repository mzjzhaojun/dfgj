...
public class Teacherrefundallots implements Serializable {
	...
	public Teacherrefundallots(Long id, Integer version, Long refundallotid, Long staffid, Long customerid, String customercode, Long campusid,
			java.util.Date refundverifytime, Object refundallotmoney, java.util.Date createtime, Long taskid) {
		this.id = id;
