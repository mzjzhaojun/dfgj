...
public class Teachgroupperfmonthsum implements Serializable {
	...
	public Teachgroupperfmonthsum(Long id, Integer version, Long regionid, Long branchid, Long campusid, Long groupid, Integer year, Integer month,
			Object hourcount, Object hourcounttask, Object renewalmoney, Object refundmoney, Object onetoonehourcount, Object onetoonecampusrank,
			Object onetoonebranchrank, Object onetoonecountryrank, Object grouphourcount, Object groupcampusrank, Object groupbranchrank,
			Object groupcountryrank, java.util.Date createtime) {
		this.id = id;
