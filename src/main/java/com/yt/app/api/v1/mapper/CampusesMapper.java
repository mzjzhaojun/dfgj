...
public interface CampusesMapper extends IBaseMapper<Campuses> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Campuses.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Campuses.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Campuses.class)
	public List<Campuses> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Campuses.class)
	public List<Campuses> listByArrayId(long[] id);
}