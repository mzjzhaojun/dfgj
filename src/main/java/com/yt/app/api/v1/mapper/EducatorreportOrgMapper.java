...
public interface EducatorreportOrgMapper extends IBaseMapper<EducatorreportOrg> {
/**
 * 保存（持久化）对象
 * 
 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { EducatorreportOrg.class})
...
*/
	@RedisCacheAnnotation(classs = EducatorreportOrg.class)
...
*/
	@RedisCacheAnnotation(classs = EducatorreportOrg.class)
	public List<EducatorreportOrg> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = EducatorreportOrg.class)
	public List<EducatorreportOrg> listByArrayId(long[] id);
}