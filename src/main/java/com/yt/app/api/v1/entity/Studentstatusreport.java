...
public class Studentstatusreport implements Serializable {
	...
	public Studentstatusreport(Long id, Integer version, Long snapshotid, String regionid, String regionshortname, String branchid,
			String branchshortname, String campusid, String campusshortname, Integer campusage, Integer earlyisreg, Integer earlyhasnomoney,
			Integer earlyhasmoney, Integer earlyisavailable, Integer earlyclasssuspended, Integer earlyactive, Integer earlyschoolsuspended,
			Integer earlygraduated, Integer curnewsign, Integer currenewsign, Integer graduatedrenewsign, Integer schoolsuspendedrenewsign,
			Integer classsuspendedrenewsign, Integer activerenewsign, Integer classfinishedrenewsign, Integer newsignrenewsign, Integer curassigned,
			Integer graduateassigned, Integer schoolsuspendedassigned, Integer classsuspendedassigned, Integer activeassigned,
			Integer classfinishedassigned, Integer newsignassigned, Integer curtransferedin, Integer curtransferedout,
			Integer curtransferschooltransferedin, Integer curtransferschooltransferedout, Integer curclassfinished, Integer refundclassfinished,
			Integer assignedclassfinished, Integer transferedoutclassfinished, Integer newsignclassfinished, Integer currefund,
			Integer earlyhasmoneyrefund, Integer activerefund, Integer classsuspendedrefund, Integer schoolsuspendedrefund, Integer graduaterefund,
			Integer earlyhasnomoneyrefund, Integer newavailable, Integer notregactive, Integer graduateactive, Integer schoolsuspendedactive,
			Integer classfinishedactive, Integer thismonthactive, Integer endisreg, Integer endhasmoney, Integer endhasnomoney,
			Integer endisavailable, Integer endclasssuspended, Integer newclasssuspended, Integer endactive, Integer endgraduate,
			Integer newgraduate, Integer schoolsuspendedgraduate, Integer classsuspendedgraduate, Integer activegraduate,
			Integer classfinishedrenewsigngraduate, Integer endschoolsuspended, Integer newschoolsuspended, Integer exitavailable,
			Integer availablegraduate, Integer classsuspendedschoolsuspended, Integer classsuspendedclassfinished, Integer activeclassfinished) {
		this.id = id;
