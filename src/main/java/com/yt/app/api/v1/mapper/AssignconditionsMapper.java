...
public interface AssignconditionsMapper extends IBaseMapper<Assignconditions> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Assignconditions.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Assignconditions.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Assignconditions.class)
	public List<Assignconditions> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Assignconditions.class)
	public List<Assignconditions> listByArrayId(long[] id);
}