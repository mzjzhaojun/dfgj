...
public interface ConsultcampusperfmonthsumMapper extends IBaseMapper<Consultcampusperfmonthsum> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Consultcampusperfmonthsum.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Consultcampusperfmonthsum.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Consultcampusperfmonthsum.class)
	public List<Consultcampusperfmonthsum> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Consultcampusperfmonthsum.class)
	public List<Consultcampusperfmonthsum> listByArrayId(long[] id);
}