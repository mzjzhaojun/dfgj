...
public interface CountryCodeMapper extends IBaseMapper<CountryCode> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { CountryCode.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = CountryCode.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = CountryCode.class)
	public List<CountryCode> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = CountryCode.class)
	public List<CountryCode> listByArrayId(long[] id);
}