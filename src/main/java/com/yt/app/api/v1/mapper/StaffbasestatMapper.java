...
public interface StaffbasestatMapper extends IBaseMapper<Staffbasestat> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Staffbasestat.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Staffbasestat.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Staffbasestat.class)
	public List<Staffbasestat> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Staffbasestat.class)
	public List<Staffbasestat> listByArrayId(long[] id);
}