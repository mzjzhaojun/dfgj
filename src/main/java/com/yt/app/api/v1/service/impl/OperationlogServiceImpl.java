...
public class OperationlogServiceImpl extends BaseServiceImpl<Operationlog, Long> implements OperationlogService {
	...
	@Override
	public IPage<Operationlog> list(RequestEntity<Object> requestEntity) {
		...
		List<Operationlog> list = mapper.list(param);
		return new PageBean<Operationlog>(param, list, count);
	}

	@Override
	public Operationlog get(Long id) {
		Operationlog t = mapper.get(id);
		return t;
	}
}