...
public interface CustomerservicesMapper extends IBaseMapper<Customerservices> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Customerservices.class})
...
*/
	@RedisCacheAnnotation(classs = Customerservices.class)
...
*/
	@RedisCacheAnnotation(classs = Customerservices.class)
	public List<Customerservices> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Customerservices.class)
	public List<Customerservices> listByArrayId(long[] id);
}