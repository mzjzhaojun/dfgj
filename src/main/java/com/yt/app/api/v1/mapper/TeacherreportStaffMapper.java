...
public interface TeacherreportStaffMapper extends IBaseMapper<TeacherreportStaff> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { TeacherreportStaff.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = TeacherreportStaff.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = TeacherreportStaff.class)
	public List<TeacherreportStaff> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = TeacherreportStaff.class)
	public List<TeacherreportStaff> listByArrayId(long[] id);
}