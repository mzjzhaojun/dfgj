...
public interface ExpensepermissionsMapper extends IBaseMapper<Expensepermissions> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Expensepermissions.class})
...
*/
	@RedisCacheAnnotation(classs = Expensepermissions.class)
...
*/
	@RedisCacheAnnotation(classs = Expensepermissions.class)
	public List<Expensepermissions> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Expensepermissions.class)
	public List<Expensepermissions> listByArrayId(long[] id);
}