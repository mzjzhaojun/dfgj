...
public interface TeacherDaytaskMapper extends IBaseMapper<TeacherDaytask> {
/**
 * 保存（持久化）对象
 * 
 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { TeacherDaytask.class})
...
*/
	@RedisCacheAnnotation(classs = TeacherDaytask.class)
...
*/
	@RedisCacheAnnotation(classs = TeacherDaytask.class)
	public List<TeacherDaytask> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = TeacherDaytask.class)
	public List<TeacherDaytask> listByArrayId(long[] id);
}