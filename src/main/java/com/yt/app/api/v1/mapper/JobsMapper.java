...
public interface JobsMapper extends IBaseMapper<Jobs> {
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Jobs.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Jobs.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Jobs.class)
	public List<Jobs> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Jobs.class)
	public List<Jobs> listByArrayId(long[] id);
}