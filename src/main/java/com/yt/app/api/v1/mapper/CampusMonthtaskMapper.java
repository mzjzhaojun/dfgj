...
public interface CampusMonthtaskMapper extends IBaseMapper<CampusMonthtask> {
/**
 * 保存（持久化）对象
 * 
 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { CampusMonthtask.class})
...
*/
	@RedisCacheAnnotation(classs = CampusMonthtask.class)
...
*/
	@RedisCacheAnnotation(classs = CampusMonthtask.class)
	public List<CampusMonthtask> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = CampusMonthtask.class)
	public List<CampusMonthtask> listByArrayId(long[] id);
}