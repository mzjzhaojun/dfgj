...
public class Discounts implements Serializable{
  ...
  public Discounts(Long id,Integer version,String discountcode,String discountname,String discountstatus,java.util.Date applystartdate,java.util.Date startdate,Long branchid,String branchname,java.util.Date submittime,Long submitterid,String submittername,Long submitterjobid,String submitterjobname,Long approverid,String approvername,Long approverjobid,String approverjobname,java.util.Date approvetime,Long creatorid,String creatorname,java.util.Date createtime,Long modifierid,String modifiername,java.util.Date modifytime){
      this.id=id;
