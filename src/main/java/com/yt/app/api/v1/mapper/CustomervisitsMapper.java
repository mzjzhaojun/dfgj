...
public interface CustomervisitsMapper extends IBaseMapper<Customervisits> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Customervisits.class})
...
*/
	@RedisCacheAnnotation(classs = Customervisits.class)
...
*/
	@RedisCacheAnnotation(classs = Customervisits.class)
	public List<Customervisits> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Customervisits.class)
	public List<Customervisits> listByArrayId(long[] id);
}