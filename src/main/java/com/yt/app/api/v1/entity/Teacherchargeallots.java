...
public class Teacherchargeallots implements Serializable {
	...
	public Teacherchargeallots(Long id, Integer version, Long chargeallotid, Long staffid, Long customerid, String customercode, Long campusid,
			java.util.Date chargepaytime, Object chargeallotmoney, java.util.Date createtime, Long taskid) {
		this.id = id;
