...
public class Consultbranchperfmonthsum implements Serializable {
	...
	public Consultbranchperfmonthsum(Long id, Integer version, Long regionid, Long branchid, Integer year, Integer month, Object moneycount,
			Object moneybranchrank, Integer moneyregionrank, Integer moneycountryrank, Object moneygrowthrate, Object peoplecount,
			Object peoplebranchrank, Integer peopleregionrank, Integer peoplecountryrank, Object newmoneytask, Object newmoney,
			String newmoneybranchrank, Integer newmoneyregionrank, Integer newmoneycountryrank, Integer newpeoplecount, Integer newpeoplebranchrank,
			Integer newpeoplecountryrank, Integer newpeoplecounttask, java.util.Date createtime) {
		this.id = id;
