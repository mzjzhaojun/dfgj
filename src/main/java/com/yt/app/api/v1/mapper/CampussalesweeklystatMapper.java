...
public interface CampussalesweeklystatMapper extends IBaseMapper<Campussalesweeklystat> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Campussalesweeklystat.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Campussalesweeklystat.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Campussalesweeklystat.class)
	public List<Campussalesweeklystat> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Campussalesweeklystat.class)
	public List<Campussalesweeklystat> listByArrayId(long[] id);
}