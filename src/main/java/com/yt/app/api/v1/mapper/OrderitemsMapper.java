...
public interface OrderitemsMapper extends IBaseMapper<Orderitems> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Orderitems.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Orderitems.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Orderitems.class)
	public List<Orderitems> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Orderitems.class)
	public List<Orderitems> listByArrayId(long[] id);
}