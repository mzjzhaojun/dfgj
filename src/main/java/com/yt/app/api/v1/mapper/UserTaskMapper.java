...
public interface UserTaskMapper extends IBaseMapper<UserTask> {
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { UserTask.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = UserTask.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = UserTask.class)
	public List<UserTask> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = UserTask.class)
	public List<UserTask> listByArrayId(long[] id);
}