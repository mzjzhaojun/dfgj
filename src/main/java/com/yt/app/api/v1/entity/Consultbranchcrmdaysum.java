...
public class Consultbranchcrmdaysum implements Serializable {
	...
	public Consultbranchcrmdaysum(Long id, Integer version, Long regionid, Long branchid, Integer year, Integer month, Integer day,
			Integer followingcountofpotential, Integer followingcountofstudent, Integer verifyingcount, Integer signingcount,
			Integer weekfollowingcountofpotential, Integer weekfollowingcountofstudent, Integer weekverifyingcount, Integer weeksigningcount,
			java.util.Date createtime) {
		this.id = id;
