...
public interface CategoriesMapper extends IBaseMapper<Categories> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Categories.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Categories.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Categories.class)
	public List<Categories> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Categories.class)
	public List<Categories> listByArrayId(long[] id);
}