...
public class Accountchargeallots implements Serializable {
	...
	public Accountchargeallots(Long id, Integer version, Long applyid, Long teacherid, String teachername, String teacheroacode, Long teacherjobid,
			String teacherjobname, Integer isfulltimeteacher, String subject, String categorytype, Object allotamount, Object allotmoney) {
		this.id = id;
