...
public interface AccountrefundappliesMapper extends IBaseMapper<Accountrefundapplies> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Accountrefundapplies.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Accountrefundapplies.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Accountrefundapplies.class)
	public List<Accountrefundapplies> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Accountrefundapplies.class)
	public List<Accountrefundapplies> listByArrayId(long[] id);
}