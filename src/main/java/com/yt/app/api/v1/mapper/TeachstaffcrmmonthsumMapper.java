...
public interface TeachstaffcrmmonthsumMapper extends IBaseMapper<Teachstaffcrmmonthsum> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Teachstaffcrmmonthsum.class})
...
*/
	@RedisCacheAnnotation(classs = Teachstaffcrmmonthsum.class)
...
*/
	@RedisCacheAnnotation(classs = Teachstaffcrmmonthsum.class)
	public List<Teachstaffcrmmonthsum> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Teachstaffcrmmonthsum.class)
	public List<Teachstaffcrmmonthsum> listByArrayId(long[] id);
}