...
public class OtherproductincomeweeklyServiceImpl extends BaseServiceImpl<Otherproductincomeweekly, Long> implements OtherproductincomeweeklyService {
	...
	@Override
	public Integer post(Otherproductincomeweekly t) {
	...
	@Override
	public IPage<Otherproductincomeweekly> list(RequestEntity<Object> requestEntity) {
		...
		List<Otherproductincomeweekly> list = mapper.list(param);
		return new PageBean<Otherproductincomeweekly>(param, list, count);
	}

	@Override
	public Otherproductincomeweekly get(Long id) {
		Otherproductincomeweekly t = mapper.get(id);
		return t;
	}
}