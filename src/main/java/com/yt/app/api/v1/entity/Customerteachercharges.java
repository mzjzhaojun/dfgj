...
public class Customerteachercharges implements Serializable {
	...
	public Customerteachercharges(Long id, Integer version, Long customerid, Long teacherid, java.util.Date statlocaldate, Long campusid,
			Object newchargeamount, Object renewamount, Object refundamount) {
		this.id = id;
