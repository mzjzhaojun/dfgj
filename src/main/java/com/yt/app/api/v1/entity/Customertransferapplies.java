...
public class Customertransferapplies implements Serializable {
	...
	public Customertransferapplies(Long id, Integer version, Long campusid, String campusname, Long customerid, String applystatus,
			java.util.Date applytime, String applymemo, Long applierid, String appliername, Long applierjobid, String applierjobname,
			String processstatus, java.util.Date processtime, String processmemo, String transfertype, Long tocampusid, String tocampusname,
			Long submitterid, String submittername, Long submitterjobid, String submitterjobname, java.util.Date submittime, Long approverid,
			String approvername, Long approverjobid, String approverjobname, java.util.Date approvetime, Long creatorid, String creatorname,
