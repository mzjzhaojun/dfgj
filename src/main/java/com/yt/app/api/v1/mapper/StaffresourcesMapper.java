...
public interface StaffresourcesMapper extends IBaseMapper<Staffresources> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Staffresources.class})
...
*/
	@RedisCacheAnnotation(classs = Staffresources.class)
...
*/
	@RedisCacheAnnotation(classs = Staffresources.class)
	public List<Staffresources> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Staffresources.class)
	public List<Staffresources> listByArrayId(long[] id);
}