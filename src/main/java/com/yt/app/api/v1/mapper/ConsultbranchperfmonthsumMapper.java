...
public interface ConsultbranchperfmonthsumMapper extends IBaseMapper<Consultbranchperfmonthsum> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Consultbranchperfmonthsum.class})
...
*/
	@RedisCacheAnnotation(classs = Consultbranchperfmonthsum.class)
...
*/
	@RedisCacheAnnotation(classs = Consultbranchperfmonthsum.class)
	public List<Consultbranchperfmonthsum> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Consultbranchperfmonthsum.class)
	public List<Consultbranchperfmonthsum> listByArrayId(long[] id);
}