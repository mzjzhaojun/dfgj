 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Repertories.class})
...
*/
	@RedisCacheAnnotation(classs = Repertories.class)
...
*/
	@RedisCacheAnnotation(classs = Repertories.class)
	public List<Repertories> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Repertories.class)
	public List<Repertories> listByArrayId(long[] id);
}