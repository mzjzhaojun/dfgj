...
public interface CustomerverifiesMapper extends IBaseMapper<Customerverifies> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Customerverifies.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Customerverifies.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Customerverifies.class)
	public List<Customerverifies> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Customerverifies.class)
	public List<Customerverifies> listByArrayId(long[] id);
}