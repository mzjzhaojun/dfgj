...
public class Customerstaffrelationships implements Serializable {
	...
	public Customerstaffrelationships(Long id, Integer version, Long customerid, Long staffid, java.util.Date statlocaldate, String relationtype,
			Long campusid, Long referralstaffid, Long referralcustomerid, Object accountvalue, java.util.Date lastestclasstime,
			java.util.Date lastestpaytime, java.util.Date lastestrefundverifytime, Object onetooneamountinasset, Object classgroupamountinasset,
			Object youxueamountinasset, Object otheramountinasset, Object totalamountinasset, String isavailable, String isclasssuspended,
			String isactive, String isschoolsuspended, String isclassfinished, Integer graduated) {
		this.id = id;
