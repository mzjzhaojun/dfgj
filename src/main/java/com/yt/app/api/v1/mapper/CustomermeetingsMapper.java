...
public interface CustomermeetingsMapper extends IBaseMapper<Customermeetings> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Customermeetings.class})
...
*/
	@RedisCacheAnnotation(classs = Customermeetings.class)
...
*/
	@RedisCacheAnnotation(classs = Customermeetings.class)
	public List<Customermeetings> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Customermeetings.class)
	public List<Customermeetings> listByArrayId(long[] id);
}