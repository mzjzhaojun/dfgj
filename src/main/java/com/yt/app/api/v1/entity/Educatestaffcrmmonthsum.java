...
@Getter
@Setter
public class Educatestaffcrmmonthsum implements Serializable {
	...
	public Educatestaffcrmmonthsum() {
	}

	public Educatestaffcrmmonthsum(Long id, Integer version, Long regionid, Long branchid, Long campusid, Long staffid, Long staffjobid,
			Integer year, Integer month, Integer classpeoplecount, Integer initialeffective, Integer neweffective, Integer classhours,
			Integer finaleffective, Integer renewalcount, Integer endclasscount, Integer refundcount, Integer remaininghourscount,
			Integer outschoolwarningcount, Integer closedwarningcount, Integer refundwarningcount, Integer waitvisitingcount,
			Integer waitweekfeedbackcount, Integer waitmeetingcount, Integer waitordercount, Integer birthdaytoday, Integer birthdayfuture,
			Integer managestudentcount, Integer validstudentcount, Integer noclassstudentcount, Integer closedstudentcount,
