...
public interface UserTaskcategoryMapper extends IBaseMapper<UserTaskcategory> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { UserTaskcategory.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = UserTaskcategory.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = UserTaskcategory.class)
	public List<UserTaskcategory> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = UserTaskcategory.class)
	public List<UserTaskcategory> listByArrayId(long[] id);
}