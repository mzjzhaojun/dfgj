...
public class Educatestaffperfmonthsum implements Serializable {
	...
	public Educatestaffperfmonthsum(Long id, Integer version, Long regionid, Long branchid, Long campusid, Long staffid, Long staffjobid,
			Integer year, Integer month, Integer onetoonehourcount, Object onetoonehourincome, Integer onetoonecampusrank,
			Integer onetoonebranchrank, Integer onetoonecountryrank, Integer grouphourcount, Object grouphourincome, Integer groupcampusrank,
			Integer groupbranchrank, Integer groupcountryrank, Object renewalmoney, Integer renewalcampusrank, Integer renewalbranchrank,
			Integer renewalcountryrank, Object refundmoney, Integer hourcounttask, Object renewalmoneytask, java.util.Date createtime) {
		this.id = id;
