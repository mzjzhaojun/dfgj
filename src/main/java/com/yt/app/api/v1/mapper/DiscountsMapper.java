...
public interface DiscountsMapper extends IBaseMapper<Discounts> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Discounts.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Discounts.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Discounts.class)
	public List<Discounts> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Discounts.class)
	public List<Discounts> listByArrayId(long[] id);
}