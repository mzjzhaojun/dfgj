...
public class Products implements Serializable{
  ...
  public Products(Long id,Integer version,Long rdorgid,String rdorgname,String productcode,String productname,String productmemo,String productstatus,String productversion,Object productprice,Object productcost,String productunit,Object targetprice,String targetpricememo,String catalog,String subject,String grade,String year,String season,java.util.Date startdate,java.util.Date enddate,Long partnerid,Object partnerratio,String partnername,Integer specialallowed,Integer tunlandallowed,Integer presentallowed,Integer promotionallowed,Object promotionquota,java.util.Date confirmstartdate,java.util.Date confirmenddate,String confirmmode,Integer confirmstaging,Long submitterid,String submittername,Long submitterjobid,String submitterjobname,java.util.Date submittime,Long approverid,String approvername,Long approverjobid,String approverjobname,java.util.Date approvetime,Long creatorid,String creatorname,java.util.Date createtime,Long modifierid,String modifiername,java.util.Date modifytime){
      this.id=id;
