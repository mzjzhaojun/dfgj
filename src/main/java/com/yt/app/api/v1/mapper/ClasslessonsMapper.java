...
public interface ClasslessonsMapper extends IBaseMapper<Classlessons> {
/**
 * 保存（持久化）对象
 * 
 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Classlessons.class})
...
*/
	@RedisCacheAnnotation(classs = Classlessons.class)
...
*/
	@RedisCacheAnnotation(classs = Classlessons.class)
	public List<Classlessons> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Classlessons.class)
	public List<Classlessons> listByArrayId(long[] id);
}