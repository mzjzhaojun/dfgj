...
public class CustomerserviceitemsServiceImpl extends BaseServiceImpl<Customerserviceitems, Long> implements CustomerserviceitemsService {
	...
	@Override
	@Transactional
	public Integer post(Customerserviceitems t) {
	...
	@Override
	public IPage<Customerserviceitems> list(RequestEntity<Object> requestEntity) {
		...
		List<Customerserviceitems> list = mapper.list(param);
		return new PageBean<Customerserviceitems>(param, list, count);
	}

	@Override
	public Customerserviceitems get(Long id) {
		Customerserviceitems t = mapper.get(id);
		return t;
	}
}