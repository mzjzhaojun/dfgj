...
public interface SchoolsMapper extends IBaseMapper<Schools> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Schools.class})
...
*/
	@RedisCacheAnnotation(classs = Schools.class)
...
*/
	@RedisCacheAnnotation(classs = Schools.class)
	public List<Schools> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Schools.class)
	public List<Schools> listByArrayId(long[] id);
}