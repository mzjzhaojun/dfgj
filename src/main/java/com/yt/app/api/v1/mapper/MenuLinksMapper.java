...
public interface MenuLinksMapper extends IBaseMapper<MenuLinks> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { MenuLinks.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = MenuLinks.class)
	public List<MenuLinks> list(Map<String, Object> param);
