...
public interface EducatorWeektaskMapper extends IBaseMapper<EducatorWeektask> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { EducatorWeektask.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = EducatorWeektask.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = EducatorWeektask.class)
	public List<EducatorWeektask> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = EducatorWeektask.class)
	public List<EducatorWeektask> listByArrayId(long[] id);
}