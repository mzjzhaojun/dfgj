...
public class UserTask implements Serializable {
	...
	public UserTask(Long id, Integer version, String application_name, String program_name, Integer task_level, String task_title, Long resource_id,
			Long process_id, Long activity_id, String url, String data, Integer emergency, String purpose, String status,
			java.util.Date task_start_time, java.util.Date expire_time, Long source_id, String source_name, Long send_to_user,
			String send_to_user_name, java.util.Date read_time, Long category_guid, Integer top_flag, String draft_department_name,
			java.util.Date deliver_time, Long draft_user_id, String draft_user_name, Integer operation_type, String operation_name,
			String from_transition_key, String from_transition_name, Long from_activity_id, String from_activity_key, String to_activity_key) {
		this.id = id;
