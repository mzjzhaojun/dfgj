...
public interface RefundreportMapper extends IBaseMapper<Refundreport> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Refundreport.class})
...
*/
	@RedisCacheAnnotation(classs = Refundreport.class)
...
*/
	@RedisCacheAnnotation(classs = Refundreport.class)
	public List<Refundreport> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Refundreport.class)
	public List<Refundreport> listByArrayId(long[] id);
}