...
public interface PresentsMapper extends IBaseMapper<Presents> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Presents.class})
...
*/
	@RedisCacheAnnotation(classs = Presents.class)
...
*/
	@RedisCacheAnnotation(classs = Presents.class)
	public List<Presents> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Presents.class)
	public List<Presents> listByArrayId(long[] id);
}