...
public class StafftaskServiceImpl extends BaseServiceImpl<Stafftask, Long> implements StafftaskService {
	...
	@Override
	@Transactional
	public Integer post(Stafftask t) {
	...
	@Override
	public IPage<Stafftask> list(RequestEntity<Object> requestEntity) {
		...
		List<Stafftask> list = mapper.list(param);
		return new PageBean<Stafftask>(param, list, count);
	}

	@Override
	public Stafftask get(Long id) {
		Stafftask t = mapper.get(id);
		return t;
	}
}