...
public interface CampustaskMapper extends IBaseMapper<Campustask> {
/**
 * 保存（持久化）对象
 * 
 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Campustask.class})
...
*/
	@RedisCacheAnnotation(classs = Campustask.class)
...
*/
	@RedisCacheAnnotation(classs = Campustask.class)
	public List<Campustask> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Campustask.class)
	public List<Campustask> listByArrayId(long[] id);
}