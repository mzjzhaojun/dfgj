...
public interface ClassesMapper extends IBaseMapper<Classes> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Classes.class})
...
*/
	@RedisCacheAnnotation(classs = Classes.class)
...
*/
	@RedisCacheAnnotation(classs = Classes.class)
	public List<Classes> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Classes.class)
	public List<Classes> listByArrayId(long[] id);
}