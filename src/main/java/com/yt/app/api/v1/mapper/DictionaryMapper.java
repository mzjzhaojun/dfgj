...
public interface DictionaryMapper extends IBaseMapper<Dictionary> {
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Dictionary.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Dictionary.class)
	public List<Dictionary> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Dictionary.class)
	public List<Dictionary> listByArrayTypeCode(long[] id);
	 ...
	 */
	@RedisCacheAnnotation(classs = Dictionary.class)
	public Dictionary getByCode(long id);
}