...
public class ConsultcampusperfdaysumServiceImpl extends BaseServiceImpl<Consultcampusperfdaysum, Long> implements ConsultcampusperfdaysumService {
	...
	@Override
	public Integer post(Consultcampusperfdaysum t) {
	...
	@Override
	public IPage<Consultcampusperfdaysum> list(RequestEntity<Object> requestEntity) {
		...
		List<Consultcampusperfdaysum> list = mapper.list(param);
		return new PageBean<Consultcampusperfdaysum>(param, list, count);
	}

	@Override
	public Consultcampusperfdaysum get(Long id) {
		Consultcampusperfdaysum t = mapper.get(id);
		return t;
	}
}