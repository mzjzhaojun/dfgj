...
public interface ConsultantMonthtaskMapper extends IBaseMapper<ConsultantMonthtask> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { ConsultantMonthtask.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = ConsultantMonthtask.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = ConsultantMonthtask.class)
	public List<ConsultantMonthtask> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = ConsultantMonthtask.class)
	public List<ConsultantMonthtask> listByArrayId(long[] id);
}