...
public interface AccountrecordsMapper extends IBaseMapper<Accountrecords> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Accountrecords.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Accountrecords.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Accountrecords.class)
	public List<Accountrecords> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Accountrecords.class)
	public List<Accountrecords> listByArrayId(long[] id);
}