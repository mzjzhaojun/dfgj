...
public interface StaffchargestatMapper extends IBaseMapper<Staffchargestat> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Staffchargestat.class})
...
*/
	@RedisCacheAnnotation(classs = Staffchargestat.class)
...
*/
	@RedisCacheAnnotation(classs = Staffchargestat.class)
	public List<Staffchargestat> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Staffchargestat.class)
	public List<Staffchargestat> listByArrayId(long[] id);
}