...
public interface CampuschargestatMapper extends IBaseMapper<Campuschargestat> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Campuschargestat.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Campuschargestat.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Campuschargestat.class)
	public List<Campuschargestat> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Campuschargestat.class)
	public List<Campuschargestat> listByArrayId(long[] id);
}