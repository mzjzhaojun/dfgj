...
@RestController
@RequestMapping("/rest/v1/discountitems")
public class DiscountitemsController extends BaseControllerImpl<Discountitems, Long> {


protected Logger logger = LoggerFactory.getLogger(this.getClass());
  @Autowired
  private DiscountitemsService service;
	...
	public ResponseEntity<Object> list(RequestEntity<Object> requestEntity, HttpServletRequest request, HttpServletResponse response) {
		...
		return new ResponseEntity<Object>(new DiscountitemsResourceAssembler().toResources(pagebean.getPageList()), pagebean.getHeaders(), HttpStatus.OK);
	}
}
