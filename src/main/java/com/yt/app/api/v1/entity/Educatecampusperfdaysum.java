...
@Getter
@Setter
public class Educatecampusperfdaysum implements Serializable {
	...
	public Educatecampusperfdaysum(Long id, Integer version, Long regionid, Long branchid, Long campusid, Integer year, Integer month, Integer day,
