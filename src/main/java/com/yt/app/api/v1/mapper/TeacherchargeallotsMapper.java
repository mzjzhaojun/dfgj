...
public interface TeacherchargeallotsMapper extends IBaseMapper<Teacherchargeallots> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Teacherchargeallots.class})
...
*/
	@RedisCacheAnnotation(classs = Teacherchargeallots.class)
...
*/
	@RedisCacheAnnotation(classs = Teacherchargeallots.class)
	public List<Teacherchargeallots> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Teacherchargeallots.class)
	public List<Teacherchargeallots> listByArrayId(long[] id);
}