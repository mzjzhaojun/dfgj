...
public interface TeachgroupperfmonthsumMapper extends IBaseMapper<Teachgroupperfmonthsum> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Teachgroupperfmonthsum.class})
...
*/
	@RedisCacheAnnotation(classs = Teachgroupperfmonthsum.class)
...
*/
	@RedisCacheAnnotation(classs = Teachgroupperfmonthsum.class)
	public List<Teachgroupperfmonthsum> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Teachgroupperfmonthsum.class)
	public List<Teachgroupperfmonthsum> listByArrayId(long[] id);
}