...
public interface OrgstaffjobsMapper extends IBaseMapper<Orgstaffjobs> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Orgstaffjobs.class})
...
*/
	@RedisCacheAnnotation(classs = Orgstaffjobs.class)
	public List<Orgstaffjobs> list(Map<String, Object> param);
