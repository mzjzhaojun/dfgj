...
public class CustomerrefundsServiceImpl extends BaseServiceImpl<Customerrefunds, Long> implements CustomerrefundsService {
	...
	@Override
	public Integer post(Customerrefunds t) {
	...
	@Override
	public IPage<Customerrefunds> list(RequestEntity<Object> requestEntity) {
		...
		List<Customerrefunds> list = mapper.list(param);
		return new PageBean<Customerrefunds>(param, list, count);
	}

	@Override
	public Customerrefunds get(Long id) {
		Customerrefunds t = mapper.get(id);
		return t;
	}
}