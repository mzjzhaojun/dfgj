...
public class Campuscustomerweeklystat implements Serializable {
	...
	public Campuscustomerweeklystat(Long id, Integer version, Integer yearkey, Integer monthkey, Integer weekkey, java.util.Date startdayofweek,
			java.util.Date enddayofweek, Long regionid, String regionname, Long branchid, String branchname, Long campusid, String campusname,
			Integer availablecustomernumberyear, Integer availablecustomernumbermb, Object accountvaluemb, Object accountmoneymb,
			Object assetsmoneymb, Integer newassignnumbertm, Integer cfrcnumbertm, Integer ssanumbertm, Integer othernewavailablenumbertm,
			Integer totalnewavailablenumbertm, Integer csssnumbertm, Integer cfnrcnumbertm, Integer cfrfnumbertm, Integer othernoneavailablenumbertm,
			Integer totalnoneavailablenumbertm, Integer netavailablechangenumbertm, Integer availablecustomernumbercurrent,
			...
			Object renewratety, Integer csanumbertm, Integer ncsnumbertm, Integer netcsnumbertm, Integer totalcsnumber, Integer ssnm1numbercurrent,
			Integer ssm1numbercurrent, Object csratecurrent, Integer classcustomernumbertm, Object classratetm) {
		this.id = id;
