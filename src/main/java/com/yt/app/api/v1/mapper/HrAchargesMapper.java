...
public interface HrAchargesMapper extends IBaseMapper<HrAcharges> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { HrAcharges.class})
...
*/
	@RedisCacheAnnotation(classs = HrAcharges.class)
...
*/
	@RedisCacheAnnotation(classs = HrAcharges.class)
	public List<HrAcharges> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = HrAcharges.class)
	public List<HrAcharges> listByArrayId(long[] id);
}