...
public interface StaffsMapper extends IBaseMapper<Staffs> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Staffs.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Staffs.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Staffs.class)
	public List<Staffs> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Staffs.class)
	public List<Staffs> listByArrayId(long[] id);
}