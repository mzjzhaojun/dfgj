...
public interface AccountdeductappliesMapper extends IBaseMapper<Accountdeductapplies> {
/**
 * 保存（持久化）对象
 * 
 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Accountdeductapplies.class})
...
*/
	@RedisCacheAnnotation(classs = Accountdeductapplies.class)
...
*/
	@RedisCacheAnnotation(classs = Accountdeductapplies.class)
	public List<Accountdeductapplies> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Accountdeductapplies.class)
	public List<Accountdeductapplies> listByArrayId(long[] id);
}