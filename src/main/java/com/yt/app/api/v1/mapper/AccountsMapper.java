...
public interface AccountsMapper extends IBaseMapper<Accounts> {
		/**
		 * 保存（持久化）对象
		 * 
		 * @param o
 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Accounts.class})
...
*/
	@RedisCacheAnnotation(classs = Accounts.class)
...
*/
	@RedisCacheAnnotation(classs = Accounts.class)
	public List<Accounts> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Accounts.class)
	public List<Accounts> listByArrayId(long[] id);
}