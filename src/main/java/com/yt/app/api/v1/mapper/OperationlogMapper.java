 ...
 * @return 执行成功的记录个数
 */
@RedisCacheEvictAnnotation(classs = { Operationlog.class})
...
*/
	@RedisCacheAnnotation(classs = Operationlog.class)
...
*/
	@RedisCacheAnnotation(classs = Operationlog.class)
	public List<Operationlog> list(Map<String, Object> param);
...
*/
	@RedisCacheAnnotation(classs = Operationlog.class)
	public List<Operationlog> listByArrayId(long[] id);
}