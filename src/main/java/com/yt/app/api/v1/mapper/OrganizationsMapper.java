...
public interface OrganizationsMapper extends IBaseMapper<Organizations> {
	/**
	 * 保存（持久化）对象
	 * 
	 * @param o
	 ...
	 * @return 执行成功的记录个数
	 */
	@RedisCacheEvictAnnotation(classs = { Organizations.class })
	 ...
	 */
	@RedisCacheAnnotation(classs = Organizations.class)
	 ...
	 */
	@RedisCacheAnnotation(classs = Organizations.class)
	public List<Organizations> list(Map<String, Object> param);
	 ...
	 */
	@RedisCacheAnnotation(classs = Organizations.class)
	public List<Organizations> listByArrayId(long[] id);
}