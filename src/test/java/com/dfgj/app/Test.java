...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(getBeanFilesList("com.yt.app.api.v1.entity.Account"));

		System.out.println(genCreateTableSql("com.yt.app.api.v1.entity.Account"));

		System.out.println(genInsertSql("com.yt.app.api.v1.entity.Account"));
	}
