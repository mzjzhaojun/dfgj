...
$(function(){
	...
	$(document).on("click","#next",function(){
		...
		if(id <= parseInt(pageCount)){
			...
			var nextPage = 3;
			var start = id-3;
			html +='<li id="Previous"><a href="javascript:;" id="Previous'+start+'">&laquo;</a></li>';
			var count = 0 ;//循环次数
			for(var i = id-2;i<=id;i++){
				...
				if(count > 3){
					...
					html +=' <li><a href="javascript:;" id="nextPage'+i+'">'+i+'</a></li>';
				}
				nextPage = i;
			}
			html +='<li id="next"><a href="javascript:;" id="next'+(nextPage+1)+'" >&raquo;</a></li>';
...
function initPage(){
	...
	var page = start - 1;
	var html = "";
	html +='<li id="Previous"><a href="#" id="Previous'+page+'">&laquo;</a></li>';
	for(var i = start;i<=nextPage;i++){
		html +=' <li><a href="#" id="nextPage'+i+'">'+i+'</a></li>';
	}
	html +='<li id="next"><a href="#" id="next'+(nextPage+1)+'" >&raquo;</a></li>';
	$(".pagination").html(html);
